...
Components:
  1. Daily trend filter   — EMA(50) vs EMA(200) on daily closes
  2. Intraday entry       — Donchian-20 breakout on 15m bars (gated by trend)
...
class StrategyConfig:
    ...
    bars_per_year: float = 252.0 * 20.0   # ~20 fifteen-min bars per session × 252
